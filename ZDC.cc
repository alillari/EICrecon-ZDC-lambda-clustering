...
#include "algorithms/calorimetry/MaxFindingConfig.h"
...
#include "factories/calorimetry/PeakFinding_factory.h"
...
extern "C" {
	...
	app->Add(new JOmniFactoryGeneratorT<PeakFinding_factory>(
            "HcalFarForwardZDCPeakHits", {"HcalFarForwardZDCRecHits"}, {"HcalFarForwardZDCPeakHits"},
            {
                .localDistXY = {1.6*side_length, side_length},
                .layerDistXY = {1.6*side_length, side_length},
            	.neighborLayersRange = 1,
		.minHitEnergy = .05 * dd4hep::MeV,
		.peakEnergyThreshold = 5 * dd4hep::MeV,
		.neighborEnergyThreshold = 10 * dd4hep::MeV,
		.minNumofNeighbors = 5,
	    },
            app   // TODO: Remove me once fixed
        ));
